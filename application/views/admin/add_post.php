      ...
      <div class="card card-small mb-3">
        <div class="card-body">
          <div class="add-new-post">
            ...
            <input class="form-control form-control-lg mb-3" type="text" placeholder="Your Post Link Download" name="post_link" value="<?= $query ? $query->post_link : '' ?>">
            <input class="form-control form-control-lg mb-3" type="text" placeholder="Your Post Image" name="post_img" value="<?= $query ? $query->post_img : '' ?>">
          </div>
        </div>
      </div>
      <!-- / Add New Post Form -->
